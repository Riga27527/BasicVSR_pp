...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path', default=r'../configs/restorers/basicvsr_plusplus/basicvsr_plusplus_c64n7_8x1_600k_rendering.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models', default=r'../work_dirs/basicvsr_plus_Bistro')
    parser.add_argument(
